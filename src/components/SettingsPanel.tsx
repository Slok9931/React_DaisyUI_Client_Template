...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  const ThemeTab = () => (
    <div className="space-y-6">
      <div>
        <Typography variant="h6" className="mb-4">Choose Theme</Typography>
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  {theme.isDark && (
                    <span className="badge badge-neutral badge-sm">Dark</span>
                  )}
                  {currentTheme.name === theme.name && (
  ...
  const FontFamilyTab = () => (
    <div className="space-y-6">
      <div>
        <Typography variant="h6" className="mb-4">Choose Font Family</Typography>
        <div className="grid grid-cols-1 gap-2 h-full overflow-y-auto">
  ...
  const TypographyTab = () => (
    <div className="space-y-6">
      <div>
        <Typography variant="h6" className="mb-4">Font Size & Weight</Typography>
      ...
      <div>
        <Typography variant="h6" className="mb-4">Spacing</Typography>
        <div className="space-y-4">
          <SliderControl
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-4 p-4 bg-base-200 rounded-lg">
          ...
          <Typography variant="caption" className="text-base-content/60">
            Caption text is the smallest variant and is used for fine print and labels.
          </Typography>
  ...
  return (
    <>
      ...
      {/* Side Panel */}
      <div className={`
        fixed top-0 right-0 h-full w-full md:w-[35%] bg-base-100 shadow-xl z-50
      ...
      `}>
        ...
        <div className="flex flex-col h-[calc(100%-70px)]">
          ...
          <div className="p-4 border-t border-base-300">
            ...
            <Typography variant="caption" className="text-base-content/60 text-center block mt-2">
